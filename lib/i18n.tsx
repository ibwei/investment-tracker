...
const translations = {
  en: {
    ...
    table: {
      ...
      noRemark: 'No note',
      deleteSuccess: 'Investment deleted. The portfolio has been refreshed.',
      deleteFailed: 'Failed to delete the investment.',
      endSuccess: 'Investment ended. It has moved to closed investments.',
    ...
    form: {
      ...
      addSuccess: 'Investment added. The portfolio has been refreshed.',
      updateSuccess: 'Investment updated. The portfolio has been refreshed.',
      saveFailed: 'Failed to save the investment.',
    },
    validation: {
    ...
    assets: {
      title: 'Assets',
      subtitle: 'Aggregate CEX, on-chain, and manual assets without mixing them into Investment.',
      ...
      summary: {
        ...
        never: 'Never',
        sourcesDescription: 'Connected asset sources',
        manualDescription: 'Included in net worth',
        failedDescription: 'Need review',
        lastSyncDescription: 'Latest successful attempt',
        changePercent: '{value}%',
      },
      allocation: {
        ...
        bySource: 'By Source',
        bySourceDescription: 'Sources are grouped first, with token distribution loaded on demand.',
        sourceTypeDescription: 'CEX, on-chain, and manual assets are kept distinct.',
        categoryDescription: 'Current allocation by balance and position categories.',
        valueLabel: 'Value',
        empty: 'No data yet.',
      ...
      topAssets: {
        ...
        manualHint: 'Manual assets are managed separately.',
        openHint: 'Opening this source syncs and loads its token distribution.',
        manualEditHint: 'Open the Manual tab to edit these assets.',
        refresh: 'Refresh',
        tokens: '{count} tokens',
        positions: '{count} positions',
        manualAssets: '{count} manual assets',
        distributionFallback: '{value}',
        emptyDetail: 'No balance or position data for this source.',
        loadFailed: 'Failed to load source detail.',
        loadingDetail: 'Loading source detail...',
      },
      trend: {
        title: 'Asset Trend',
        description: 'Snapshot history is fetched on demand and defaults to 30 days.',
        loading: 'Loading trend...',
        empty: 'No snapshot data yet.',
        totalAssets: 'Total Assets',
      },
      sources: {
        title: 'Asset Sources',
        description: 'Source-level sync state stays separate from manual assets.',
        loading: 'Loading asset sources...',
        empty: 'No asset sources yet.',
        lastSync: 'Last sync: {value}',
        ref: 'Ref: {value}',
        balances: '{balances} balances / {positions} positions',
        sync: 'Sync',
        edit: 'Edit',
        delete: 'Delete',
      },
      manualAssets: {
        title: 'Manual Assets',
        description: 'USD value is the amount used in aggregation and snapshots.',
        empty: 'No manual assets yet.',
        loading: 'Loading manual assets...',
        headers: {
          name: 'Name',
          type: 'Type',
          amount: 'Amount',
      ...
      balances: {
        balancesTitle: 'Asset Balances',
        balancesDescription: 'Loaded only when the balances tab is opened.',
        positionsTitle: 'DeFi Positions',
        positionsDescription: 'Net value uses asset value plus rewards minus debt.',
        emptyBalances: 'No balance data yet.',
        emptyPositions: 'No position data yet.',
      ...
      health: {
        failedTitle: 'Failed Sources',
        failedDescription: 'Only sanitized error summaries are shown here.',
        logsTitle: 'Recent Sync Logs',
        logsDescription: 'Latest sync attempts for this user.',
        emptyFailed: 'No source issues right now.',
        emptyLogs: 'No sync logs yet.',
        allSources: 'All Sources',
        loadingFailed: 'Loading failed sources...',
        loadingLogs: 'Loading sync logs...',
        unknownError: 'Unknown error',
      },
      forms: {
        addSourceTitle: 'Add Asset Source',
        editSourceTitle: 'Edit Asset Source',
        sourceDescription:
          'Use read-only API keys only. No trading or withdrawal permissions are needed.',
        sourceEditHint: 'Leave credential fields empty to keep the saved API key.',
        sourceTypeCex: 'CEX',
        sourceTypeOnchain: 'On-chain',
        sourceType: 'Source Type',
        provider: 'Provider',
        name: 'Name',
        namePlaceholder: 'Optional, defaults to provider name',
        apiKey: 'API Key',
        apiSecret: 'API Secret',
        passphrase: 'Passphrase',
        passphraseRequired: 'Passphrase (required)',
        passphraseOptional: 'Passphrase (optional)',
        apiKeyVersion: 'API Key Version',
        apiKeyVersionHint: 'Use the version shown in KuCoin API Management. New app-created keys may show 3.',
        walletAddress: 'Wallet Address',
        walletPlaceholder: '0x... or Solana/Sui address',
        walletHint: 'OKX Web3 sync reads wallet tokens and DeFi positions across supported chains.',
        saveSource: 'Save Source',
        saveChanges: 'Save Changes',
        addManualTitle: 'Add Manual Asset',
        editManualTitle: 'Edit Manual Asset',
        manualDescription:
          'USD value is the number that contributes to total assets, allocation, and snapshots.',
        manualNamePlaceholder: 'VOO ETF',
        amount: 'Amount',
        valueUsd: 'USD Value',
        note: 'Note',
        notePlaceholder: 'Valuation basis or update reminder',
        cancel: 'Cancel',
        saveAsset: 'Save Asset',
      },
      toast: {
        loadFailed: 'Failed to load assets.',
        saveSource: 'Source saved.',
        saveSourceWarn: 'Source saved with sync warning.',
        saveManual: 'Manual asset saved.',
        deleteManual: 'Manual asset deleted.',
        deleteSource: 'Source deleted.',
        syncDone: 'Sync finished.',
        syncWarn: 'Sync finished with warning.',
        syncAll: 'Processed {count} sources.',
        syncFailed: 'Failed to sync source.',
        syncAllFailed: 'Failed to sync all sources.',
        saveSourceFailed: 'Failed to save source.',
        saveManualFailed: 'Failed to save manual asset.',
        deleteSourceFailed: 'Failed to delete source.',
        deleteManualFailed: 'Failed to delete manual asset.',
      },
    },
    settings: {
      title: 'Settings',
      ...
      emailLockedDescription: 'Email is the account identifier and cannot be changed.',
    ...
    auth: {
      ...
      resendVerificationCodeIn: 'Resend in {seconds}s',
    ...
    errors: {
      ...
      verificationCodeCooldown: 'Please wait before requesting another verification code.',
  ...
  zh: {
    ...
    table: {
      ...
      noRemark: '无备注',
      deleteSuccess: '投资已删除，列表已刷新。',
      deleteFailed: '删除投资失败。',
      endSuccess: '投资已结束，记录已移至已结束投资。',
      endFailed: '结束投资失败。',
    ...
    form: {
      ...
      addSuccess: '投资已新增，列表已刷新。',
      updateSuccess: '投资已更新，列表已刷新。',
      saveFailed: '保存投资失败。',
    },
    validation: {
    ...
    assets: {
      title: '资产',
      subtitle: '聚合 CEX、链上和手动资产，不与收益型投资混合。',
      previewTitle: '资产预览',
      previewDescription: '未登录可先查看示例来源、手动资产、分布和趋势数据。',
      loading: '正在加载资产...',
      syncAll: '同步全部',
      addSource: '新增来源',
      addManual: '新增手动资产',
      ...
      summary: {
        ...
        noSnapshot: '暂无快照',
        never: '从未',
        sourcesDescription: '已连接的资产来源',
        manualDescription: '计入净值',
        failedDescription: '需要关注',
        lastSyncDescription: '最近一次成功同步',
        changePercent: '{value}%',
      },
      allocation: {
        bySourceType: '按来源类型',
        byCategory: '按类别',
        bySource: '按来源',
        bySourceDescription: '来源优先聚合，详情按需加载。',
        sourceTypeDescription: 'CEX、链上和手动资产分开统计。',
        categoryDescription: '按余额与仓位类别统计当前分布。',
        valueLabel: '价值',
        empty: '暂无数据。',
        loading: '图表加载中...',
      },
      topAssets: {
        ...
        empty: '暂无来源数据。',
        headerSource: '来源',
        headerDistribution: '分布',
        headerValue: '估值',
        updatedAt: '更新时间 {time}',
        manualHint: '手动资产由独立列表维护。',
        openHint: '展开会同步并加载该来源的资产分布。',
        manualEditHint: '可在手动资产标签页修改这些资产。',
        refresh: '刷新',
        tokens: '{count} 个币种',
        positions: '{count} 个仓位',
        manualAssets: '{count} 笔手动资产',
        distributionFallback: '{value}',
        emptyDetail: '该来源暂无余额或仓位数据。',
        loadFailed: '加载来源详情失败。',
        loadingDetail: '正在加载来源详情...',
      },
      trend: {
        title: '资产趋势',
        description: '趋势数据按需读取，默认展示最近 30 天。',
        loading: '正在加载趋势...',
        empty: '暂无快照数据。',
        totalAssets: '总资产',
      },
      sources: {
        title: '资产来源',
        description: '来源同步状态与手动资产分开管理。',
        loading: '正在加载资产来源...',
        empty: '暂无资产来源。',
        lastSync: '最近同步：{value}',
        ref: '引用：{value}',
        balances: '{balances} 笔余额 / {positions} 笔仓位',
        sync: '同步',
        edit: '编辑',
        delete: '删除',
      },
      ...
      balances: {
        balancesTitle: '资产余额',
        balancesDescription: '仅在打开余额 tab 时加载。',
        positionsTitle: 'DeFi 仓位',
        positionsDescription: '净值 = 资产 + 奖励 - 负债。',
        emptyBalances: '暂无余额数据。',
        emptyPositions: '暂无仓位数据。',
        loadingBalances: '余额加载中...',
        loadingPositions: '仓位加载中...',
        headers: {
          asset: '资产',
          amount: '数量',
          usdValue: '美元估值',
      ...
      health: {
        failedTitle: '失败来源',
        failedDescription: '仅展示安全处理后的错误摘要。',
        logsTitle: '最近同步日志',
        logsDescription: '当前用户最近的同步记录。',
        emptyFailed: '暂无失败来源。',
        emptyLogs: '暂无同步日志。',
        allSources: '全部来源',
        loadingFailed: '正在加载失败来源...',
        loadingLogs: '正在加载同步记录...',
        unknownError: '未知错误',
      },
      forms: {
        addSourceTitle: '新增资产来源',
        editSourceTitle: '编辑资产来源',
        sourceDescription: '仅使用只读 API Key，无需交易或提现权限。',
        sourceEditHint: '不填写凭据会保留已保存的 API Key。',
        sourceTypeCex: 'CEX',
        sourceTypeOnchain: '链上',
        sourceType: '来源类型',
        provider: 'Provider',
        name: '名称',
        namePlaceholder: '可选，默认使用 Provider 名称',
        apiKey: 'API Key',
        apiSecret: 'API Secret',
        passphraseRequired: 'Passphrase（必填）',
        passphraseOptional: 'Passphrase（可选）',
        apiKeyVersion: 'API Key 版本',
        apiKeyVersionHint: '按 KuCoin API 管理页显示的版本填写，新 Key 可能是 3。',
        walletAddress: '钱包地址',
        walletPlaceholder: '0x... 或 Solana/Sui 地址',
        walletHint: 'OKX Web3 同步会读取支持链的代币和 DeFi 仓位。',
        saveSource: '保存来源',
        saveChanges: '保存修改',
        addManualTitle: '新增手动资产',
        editManualTitle: '编辑手动资产',
        manualDescription: '美元估值将参与总资产、分布和快照统计。',
        manualNamePlaceholder: 'VOO ETF',
        amount: '金额',
        valueUsd: '美元估值',
        note: '备注',
        notePlaceholder: '估值口径或更新提示',
        cancel: '取消',
        saveAsset: '保存资产',
      },
      toast: {
        loadFailed: '加载资产失败。',
        saveSource: '来源保存成功。',
        saveSourceWarn: '来源已保存，但同步出现警告。',
        saveManual: '手动资产已保存。',
        deleteManual: '手动资产已删除。',
        deleteSource: '来源已删除。',
        syncDone: '同步完成。',
        syncWarn: '同步完成，但有警告。',
        syncAll: '已处理 {count} 个来源。',
        syncFailed: '同步失败。',
        syncAllFailed: '同步全部失败。',
        saveSourceFailed: '保存来源失败。',
        saveManualFailed: '保存手动资产失败。',
        deleteSourceFailed: '删除来源失败。',
        deleteManualFailed: '删除手动资产失败。',
      },
    },
    settings: {
      title: '设置',
      ...
      emailPlaceholder: 'your@email.com',
      emailLockedDescription: '邮箱是账户唯一标识，不能更改。',
    ...
    auth: {
      ...
      resendVerificationCodeIn: '{seconds}s 后重发',
    ...
    errors: {
      ...
      userNotFound: '用户不存在。',
      emailInUse: '该邮箱已被使用。',
      emailCannotBeChanged: '邮箱不能更改。',
      verificationCodeInvalid: '验证码无效。',
      verificationCodeExpired: '验证码已过期。',
      verificationCodeCooldown: '请稍后再请求新的验证码。',
      requestFailed: '请求失败。',
      loginFailed: '登录失败。',
...
const serverErrorKeyMap: Record<string, string> = {
  ...
  'Email cannot be changed.': 'errors.emailCannotBeChanged',
  'Verification code is invalid.': 'errors.verificationCodeInvalid',
  'Verification code has expired.': 'errors.verificationCodeExpired',
  'Please wait before requesting another verification code.': 'errors.verificationCodeCooldown',
