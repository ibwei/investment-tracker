...
- 支持 PostgreSQL 数据持久化、组合快照、资产快照、自动结算到期投资、到期提醒和单账号 Telegram 每日总览
...
- Telegram 每日总览：UTC+8 每天 08:00 只刷新配置账号的资产，然后推送昨日预计理财收入和资产合计
...
TELEGRAM_BOT_TOKEN="..."
TELEGRAM_CHAT_ID="..."
TELEGRAM_REPORT_USER_EMAIL="your-report-account@example.com"
OKX_WEB3_API_KEY="..."
OKX_WEB3_API_SECRET="..."
OKX_WEB3_PASSPHRASE="..."
OKX_WEB3_PROJECT_ID="..."
...
Cron 时间按 UTC 解释。`Asia/Shanghai` / UTC+8 下，快照采集为每天 08:00 和 20:00，全量资产同步为 08:05、12:05、16:05、20:05、00:05、04:05；每日 08:00 只刷新 `TELEGRAM_REPORT_USER_EMAIL` 对应账号并推送总览。自动结束到期投资为 09:00、13:00、17:00、21:00、01:00、05:00，到期提醒为每天 10:00 和 22:00。
