...
alter table investment_daily_snapshots
...
create index if not exists asset_balances_user_value_idx
  on asset_balances(user_id, value_usd desc, id desc)
...
create index if not exists asset_positions_user_net_value_idx
  on asset_positions(user_id, net_value_usd desc, id desc);
...
create index if not exists asset_sync_logs_user_created_idx
  on asset_sync_logs(user_id, created_at desc);
